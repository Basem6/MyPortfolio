...
export default function About() {
  return (
    <section
      ...
      className="py-8 lg:py-10 relative border-t-2 border-l-2 border-r-2 border-b-0 rounded-[50px] border-gray-400/10 max-w-full overflow-hidden"
    >
      <div className="min-w-full px-8 lg:px-10 flex flex-col-reverse justify-center md:flex-row md:justify-between gap-4">
        <div className="">
          <div>
            <h2
              id="about-heading"
              className="mt-4 text-4xl pb-10 sm:text-5xl lg:text-7xl font-display font-thin text-white leading-tight"
            >
              Meet Basem
            </h2>
          ...
          <div className="py-8 mt-4 flex gap-2.5 flex-wrap">
            <p className="text-lg text-text-secondary leading-[1.8]">
              I am a secend-year Computer Science student at Tanta University,
              passionate about web development and building modern, responsive user
              interfaces. I enjoy turning ideas into real projects using frontend
