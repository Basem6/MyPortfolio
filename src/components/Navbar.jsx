          ...
          <div className="hidden md:flex  gap-2">
            {navLinks.map((link) => (
              <NavLink
                ...
                to={`/${link.href}`}
                className={() =>
                  `px-3 py-2.5 text-[15px] rounded-lg transition-all duration-300  text-gray-300/80 hover:text-white `
                }
              >
                {link.name}
              </NavLink>
            ...
            >
              <span class="fa-regular fa-star rotate-90 "></span>
              <span>Hire Me</span>
            </NavLink>
          </div>
        ...
        <div className="px-8 py-6 space-y-2">
          {navLinks.map((link) => (
            <NavLink
              ...
              to={`/${link.href}`}
              className={() =>
                `block px-5 py-4 rounded-xl transition-colors text-base`
              }
            >
              {link.name}
            </NavLink>
