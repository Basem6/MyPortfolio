    ...
    >
        <div className="max-w-full px-2 lg:px-10 ">
          <div className="flex items-center justify-between h-10 lg:h-14  max-w-full">
            {/* logo */}
            <div className="text-[23px] font-display  tracking-wide text-white hover:opacity-70 transition-opacity flex items-center  w-fit ">
              ...
              <span className="font-semibold bg-gradient-to-b font-sans from-gray-200 via-gray-300/90 to-gray-800/60 bg-clip-text text-transparent">Portfolio</span>
            </div>
            {/* Desktop Nav */}
